...
const languages = {
    en: {
        ...
        proyectos_img1_descripcion: "Website about NFTs for a client",
        proyectos_img2_descripcion: "Find the perfect movie to watch, view trailers and more",
        proyectos_img3_descripcion: "Search free stock photos online with the Unsplash API",
        proyectos_img4_descripcion: "Website for a fictional Chinese food restaurant",
        // page 2
    ...
    es: {
        ...
        proyectos_img1_descripcion: "Página web sobre NFTs hecha para un cliente",
        proyectos_img2_descripcion: "Encuentra la película perfecta para ver, mira trailers y mucho más",
        proyectos_img3_descripcion: "Descubre y descarga imagenes libres de derechos de autor hecha con la API de Unsplash",
        proyectos_img4_descripcion: "Página web para un restaurante ficticio de comida china",
        // page 2
